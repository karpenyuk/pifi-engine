...
{$ENDIF} Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  ...
  uStorage, Vcl.ComCtrls, Vcl.Menus;
...
type
  TForm2 = class(TForm)
    ...
    procedure FormMouseWheelUp(Sender: TObject; Shift: TShiftState;
      MousePos: TPoint; var Handled: Boolean);
    procedure AddMesh1Click(Sender: TObject);
  private
...
procedure TForm2.AddMesh1Click(Sender: TObject);
begin
  AddMeshForm:= TAddMeshForm.Create(self);
  try
    AddMeshForm.ShowModal;
  finally
    AddMeshForm.Free;
  end;
end;
